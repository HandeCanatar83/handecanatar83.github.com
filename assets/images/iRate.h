...
static NSString *const iRateMessageTitleKey = @"";
static NSString *const iRateAppMessageKey = @"";
static NSString *const iRateGameMessageKey = @"";
static NSString *const iRateCancelButtonKey = @"";
static NSString *const iRateRemindButtonKey = @"";
static NSString *const iRateRateButtonKey = @"";
