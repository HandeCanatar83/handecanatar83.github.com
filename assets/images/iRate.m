...
{
    return [_messageTitle ?: [self localizedStringForKey:iRateMessageTitleKey withDefault:@"Oyla %@"] stringByReplacingOccurrencesOfString:@"%@" withString:self.applicationName];
}
...
- (NSString *)message
{
    ...
    if (!message)
    {
        message = (self.appStoreGenreID == iRateAppStoreGameGenreID)? [self localizedStringForKey:iRateGameMessageKey withDefault:@"%@, uygulamasını beğendiniz mi? Desteğiniz için teşekkür ederiz."]: [self localizedStringForKey:iRateAppMessageKey withDefault:@"%@, uygulamasını beğendiniz mi? Desteğiniz için teşekkür ederiz."];
    }
...
{
    return _cancelButtonLabel ?: [self localizedStringForKey:iRateCancelButtonKey withDefault:@"Hayır"];
}

- (NSString *)rateButtonLabel
{
    return _rateButtonLabel ?: [self localizedStringForKey:iRateRateButtonKey withDefault:@"Evet"];
}

- (NSString *)remindButtonLabel
{
    return _remindButtonLabel ?: [self localizedStringForKey:iRateRemindButtonKey withDefault:@"Daha Sonra Hatırlat"];
}
